...
export async function generarReporteExcelPorArea(areaNombre, carpetasDelArea, tipoFiltro = "todas") {
  ...
  workbook.creator = "Visor Accaso I-2";
  ...
  sheet.getCell("A3").value = "PROYECTO: MEJORAMIENTO DEL SERVICIO DE ATENCION DE SALUD BASICOS EN ACCASO DISTRITO DE PILCUYO DE LA PROVINCIA DE COLLAO DEL DEPARTAMENTO DE PUNO";
  ...
  const filaPie1 = sheet.addRow(["Documento generado automáticamente desde el Sistema de Control de Proyectos - Accaso I-2"]);
  ...
  sheet.headerFooter.oddFooter = "&L&I[Sistema Accaso I-2] Reporte institucional&R&IPágina &P de &N";
...
const FACTORES_NIVEL_SEPARADOR = [0.55, 0.68, 0.78, 0.86, 0.91, 0.95];
...
export async function generarListaSeparadoresExcel(areaNombre, carpetasDelArea) {
  ...
  for (const item of items) {
    ...
    // Sombreado por nivel — mismo nivel, mismo color. El último nivel
    // (carpetas sin hijos) queda sin sombrear, tal como se pidió.
  ...
  sheet.views = [{ state: "frozen", ySplit: FILA_ENCABEZADO }];
  sheet.headerFooter.oddFooter = "&L&I[Sistema ACCASO I-2] Índice de separadores&R&IPágina &P de &N";
